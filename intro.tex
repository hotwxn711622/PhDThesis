...
concurrent abstraction layers. Here, we have a very effective way of representing
states shared by processes running on other CPUs, and enforcing invariants on
the current process, and assumptions on the other processes. Using this framework,
...
the verified locks to implement other concurrent part of the kernel.
