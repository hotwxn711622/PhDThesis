...
so that we each process traps into the kernel, we no longer need to switch to the kernel page table, 
...
and get stuck if not, even though in the implementation, we do not perform this check.
